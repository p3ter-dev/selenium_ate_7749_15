 ...
 * Fulfills all 8 course requirements (T1 to T8) for Addis Ababa University
...
public class ParaBankAutomationTests extends BaseTest {
         ...
         * Locates elements using at least two different strategies (By.name,
         * By.cssSelector, By.xpath, By.className, By.id).
         ...
         * User registration -> Confirmation -> Navigation to Transfer Funds -> Execute
         * Transfer -> Assert Confirmation.
         */
        @Test
        ...
        public void testT4_NegativePathInvalidCredentialsAndBlankForms() {
                ...
                assertAll("Registration Validation Errors",
                                () -> assertThat(registerPage.isFirstNameErrorDisplayed())
                                                .as("First name error is displayed").isTrue(),
                                () -> assertThat(registerPage.getFirstNameError()).as("First name required message")
                                                .isEqualTo("First name is required."),
                                () -> assertThat(registerPage.isUsernameErrorDisplayed())
                                                .as("Username error is displayed").isTrue(),
                                () -> assertThat(registerPage.getUsernameError()).as("Username required message")
                                                .isEqualTo("Username is required."));
        }

        /**
         * T5: Explicit Wait
         * Uses WebDriverWait with ExpectedConditions to synchronize with asynchronous
         * AJAX state updates.
         */
        @Test
        ...
        static Stream<Arguments> loginEquivalencePartitions() {
                ...
                return Stream.of(
                                Arguments.of("EP1: Valid Registered Credentials", validDynamicUser, "ValidPass123!", "",
                                                true),
                                Arguments.of("EP2: Non-existent Account", "invalid_nonexistent_user", "wrongpass",
                                                "The username and password could not be verified.", false),
                                Arguments.of("EP3: Empty Username", "", "SomePassword123!",
                                                "Please enter a username and password.", false),
                                Arguments.of("EP4: Empty Password", "some_username", "",
                                                "Please enter a username and password.", false),
                                Arguments.of("EP5: Empty Username and Password", "", "",
                                                "Please enter a username and password.", false));
        }

        /**
         * T7: Page Object Encapsulation Test
         * Verifies that user flows and state transitions are entirely encapsulated
         * within Page Objects.
         */
        @Test
